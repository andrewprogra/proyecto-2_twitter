...
public class V_NuevaCuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_CuentaCreada.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_CuentaCreadaMouseClicked(evt);
            }
        });
    ...
    private void btn_CuentaCreadaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_CuentaCreadaMouseClicked
        
        
        if(txt_Edad.getText().equals("")||txt_Genero.getText().equals("")||txt_Nombre.getText().equals("")||txt_Username.getText().equals("")||txt_password.getText().equals("")||txt_Verificacion_pasword.getText().equals("")){
        JOptionPane.showMessageDialog(null,"Error,debe de llenar todos los campos");
        } else{
        dispose();
        }
        if(!txt_Verificacion_pasword.getText().equals(txt_password.getText())){
        JOptionPane.showMessageDialog(null,"Error,password no coinciden");
        }
        
        String[] N_usuario=new String[100];
        int i=0;
        int j=0;
     ...
     for( i=0;i<N_usuario.length;i++){
        System.out.println(N_usuario[i]);
           }
       
        String password=txt_password.getText();
        N_usuario[j]=password;
        j++;
        
           for( j=0;j<N_usuario.length;j++){
        System.out.println(N_usuario[j]);
           }
    ...
    }//GEN-LAST:event_btn_CuentaCreadaMouseClicked
